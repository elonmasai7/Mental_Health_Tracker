...
function setupUi() {
    ...
    if (_data.volume.file != null) {
        ...
        jQuery('#threshold-volume').dragslider("option", "values", [4, volume.max]);
        ...
        jQuery('#windowlevel-volume').dragslider("option", "values", [volume.min, volume.max]);
    ...
    if (_data.scalars.file != null) {
        ...
        jQuery("#threshold-scalars").dragslider("option", "values", [mesh.scalars.min * 100, mesh.scalars.max * 100]);
    ...
    if (_data.fibers.file != null) {
        ...
        jQuery("#threshold-fibers").dragslider("option", "values", [fibers.scalars.min, fibers.scalars.max]);
