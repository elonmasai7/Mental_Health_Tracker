                        ...
                        if (!regexp.test(email)) {
                            ...
                            jQuery.post(CLOE_BROOKS_STORAGE['ajax_url'], {
                                ...
                                try {
                                    ...
                                    rez = {
                                        error: CLOE_BROOKS_STORAGE['ajax_error']
                                    };
...
function cloe_brooks_sc_init_scroll_area(obj) {
    ...
    if (!cloe_brooks_check_images_complete(obj) && CLOE_BROOKS_STORAGE['scroll_init_counter']++ < 30) {
        setTimeout(function() {
            cloe_brooks_sc_init_scroll_area(obj);
        }, 200);
        return;
    }
        ...
        var o = {
            ...
            diagram: function() {
                ...
                r.circle(c, c, Math.round(w / 2)).attr({
                    stroke: 'none',
                    fill: CLOE_BROOKS_STORAGE['theme_skin_bg_color'] ? CLOE_BROOKS_STORAGE['theme_skin_bg_color'] : '#ffffff'
                });
        ...
        error = cloe_brooks_form_validate(form, {
            ...
            rules: [{
                ...
                },
                {
                    ...
                    min_length: {
                        value: 7,
                        message: CLOE_BROOKS_STORAGE['strings']['phone_empty']
                    },
                    max_length: {
                        value: 60,
                        message: CLOE_BROOKS_STORAGE['strings']['phone_long']
                    },
                    mask: {
                        value: CLOE_BROOKS_STORAGE['phone_mask'],
                        message: CLOE_BROOKS_STORAGE['strings']['phone_not_valid']
                    }
                },
                {
                    field: "subject",
                    min_length: {
                        value: 1,
                        message: CLOE_BROOKS_STORAGE['strings']['subject_empty']
                    },
                    max_length: {
                        value: 100,
                        message: CLOE_BROOKS_STORAGE['strings']['subject_long']
                    }
                },
                {
                    field: "message",
                    ...
                    max_length: {
                        value: CLOE_BROOKS_STORAGE['contacts_maxlength'],
...
function cloe_brooks_menuitems_show_popup(obj) {
    ...
    jQuery.post(CLOE_BROOKS_STORAGE['ajax_url'], {
        ...
        try {
            ...
            rez = {
                error: CLOE_BROOKS_STORAGE['ajax_error'] + '<br>' + response
            };
        }
