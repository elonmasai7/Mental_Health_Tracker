...
function updateMeshMatrix() {
    ...
    mesh.transform.matrix = new X.matrix(
        [
            [matrix11, matrix12, matrix13, matrix14],
            [matrix21, matrix22, matrix23, matrix24],
            [matrix31, matrix32, matrix33, matrix34],
            [matrix41, matrix42, matrix43, matrix44]
        ]);
    mesh.modified();
...
function updateMeshMatrixDialog() {
    ...
    var matrix11 = parseFloat(m1[0]);
    $('#matrix11').val(matrix11);
    var matrix12 = parseFloat(m1[1]);
    $('#matrix12').val(matrix12);
    var matrix13 = parseFloat(m1[2]);
    $('#matrix13').val(matrix13);
    var matrix14 = parseFloat(m1[3]);
    $('#matrix14').val(matrix14);
    var m2 = matrix[1].split(/[\s]+/);
    var matrix21 = parseFloat(m2[0]);
    $('#matrix21').val(matrix21);
    var matrix22 = parseFloat(m2[1]);
    $('#matrix22').val(matrix22);
    var matrix23 = parseFloat(m2[2]);
    $('#matrix23').val(matrix23);
    var matrix24 = parseFloat(m2[3]);
    $('#matrix24').val(matrix24);
    var m3 = matrix[2].split(/[\s]+/);
    var matrix31 = parseFloat(m3[0]);
    $('#matrix31').val(matrix31);
    var matrix32 = parseFloat(m3[1]);
    $('#matrix32').val(matrix32);
    var matrix33 = parseFloat(m3[2]);
    $('#matrix33').val(matrix33);
    var matrix34 = parseFloat(m3[3]);
    $('#matrix34').val(matrix34);
    var m4 = matrix[3].split(/[\s]+/);
    var matrix41 = parseFloat(m4[0]);
    $('#matrix41').val(matrix41);
    var matrix42 = parseFloat(m4[1]);
    $('#matrix42').val(matrix42);
    var matrix43 = parseFloat(m4[2]);
    $('#matrix43').val(matrix43);
    var matrix44 = parseFloat(m4[3]);
    $('#matrix44').val(matrix44);
